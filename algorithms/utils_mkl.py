...
#FUNCTIONS FROM : https://www.google.fr/search?ei=l3idXPH5NrzlgweaoKa4CQ&q=github+mkl+simple&oq=github+mkl+simple&gs_l=psy-ab.3...1993.2410..2655...0.0..0.48.177.4......0....1..gws-wiz.......0i7i30j0i8i7i30.wttELexPfK0
#TO REPHRASE OR QUOTE
...
def stopping_criterion(first_iteration, dJ, d, threshold):
    if first_iteration:
        return False
    else:
        M = len(dJ)
